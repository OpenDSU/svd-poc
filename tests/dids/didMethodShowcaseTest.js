...
ctxt1.registerType('DIDMethodDemo',  didMethodDescription, 'JSMicroLedger' , 1);
ctxt2.registerType('DIDMethodDemo',  didMethodDescription, 'JSMicroLedger' , 1);
ctxt3.registerType('DIDMethodDemo',  didMethodDescription, 'JSMicroLedger' , 1);
ctxt4.registerType('DIDMethodDemo',  didMethodDescription, 'JSMicroLedger' , 1);
...
async function runTest(){
    ...
    let did_v2 = await ctxt3.load(svdId);
    ...
    let did_v3 = await ctxt4.load(svdId);
